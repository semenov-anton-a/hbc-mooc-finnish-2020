...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ajoneuvorekisteri ajoNeuvo = new Ajoneuvorekisteri(); 
        ajoNeuvo.lisaa( new Rekisterinumero("FI", "AAA-111"), "Juha");
        ajoNeuvo.lisaa( new Rekisterinumero("FI", "BBB-222"), "Pekka");
        ajoNeuvo.lisaa( new Rekisterinumero("FI", "CCC-333"), "Matti");
        ajoNeuvo.tulostaRekisterinumerot();
        ajoNeuvo.tulostaOmistajat();
    }
    ...
    //     System.out.println(
    //         omistajat.get( new Rekisterinumero("FI", "ABC-123") )
    //     );

    //     System.out.println(
    //         omistajat.get( new Rekisterinumero("D", "B WQ-431") )
    //     );
